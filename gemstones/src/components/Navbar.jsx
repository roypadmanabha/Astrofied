    ...
    <header className="fixed top-0 left-0 w-full z-50 px-4 md:px-12 py-4 flex justify-between items-center bg-[#f5f5dd]/70 backdrop-blur-lg border-b shadow-sm border-black/10 shadow-black/5 transition-all duration-300">
      ...
      >
        ...
        <h1 className="text-base sm:text-xl md:text-2xl font-bold whitespace-nowrap flex items-center gap-1 md:gap-2" style={{ fontFamily: '"Nunito", sans-serif', fontWeight: 700 }}>
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-black via-[#A00000] to-[#D10000]" style={{ letterSpacing: '-0.03em' }}>
            Astrofied
          </span>
          <span className="bg-clip-text text-transparent bg-[#D10000]" style={{ letterSpacing: '-0.03em' }}>
            Gemstones
          </span>
        </h1>
      </div>
      ...
      <div className="flex gap-10 sm:gap-7 md:gap-6 font-semibold items-center font-mulish">
        <button 
          ...
          className="hover:text-[#D10000] transition-all relative group flex items-center gap-1.5 text-black bg-transparent border-none p-0 cursor-pointer font-bold"
          title="Home"
        >
          <ChevronsLeft size={16} className="sm:hidden text-black shrink-0 group-hover:text-[#D10000] transition-colors" style={{ strokeWidth: 3 }} />
          <span className="hidden sm:inline text-xs sm:text-sm md:text-base">Home</span>
          <span className="absolute -bottom-1 left-0 w-0 h-0.5 transition-all group-hover:w-full bg-[#D10000] hidden sm:block" />
        </button>
        <button 
          onClick={() => {
        ...
        <button 
          ...
          title="Order Form"
        >
          <ClipboardList size={16} className="sm:hidden text-black shrink-0 group-hover:text-[#D10000] transition-colors" />
