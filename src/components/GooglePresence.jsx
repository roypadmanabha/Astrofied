      ...
      <div className="container mx-auto max-w-[1200px] flex justify-center relative z-10">
        ...
        >
          ...
          <div className="w-full flex flex-col lg:flex-row items-center lg:items-stretch gap-10 lg:gap-16">
            ...
            <div className="w-full lg:w-[70%] flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
              ...
              <div className="flex-1 flex flex-col justify-center text-center lg:text-left">
                ...
                {/* Subtext Paragraph */}
                <p className={`text-sm sm:text-base md:text-lg leading-relaxed text-justify mb-8 lg:mb-0 font-mulish font-medium lg:font-normal ${
              ...
              {/* Call to Action Button Area (Centered vertically on desktop) */}
              <div className="w-full lg:w-auto flex justify-center items-center lg:min-w-[200px] shrink-0">
                <button
