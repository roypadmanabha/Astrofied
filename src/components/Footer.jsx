...
export default function Footer({ onOpenLegal }) {
    ...
    const socialLinks = [
        ...
        { 
            icon: (
                <svg viewBox="0 0 24 24" className="w-5 h-5 md:w-7 md:h-7">
                    ...
                    <div className="flex flex-col gap-6 w-full lg:w-auto">
                        <div className="flex items-center gap-0">
                            <img
                                src={logo}
                                alt="Astrofied Logo"
                                className="w-24 h-24 md:w-16 md:h-16 object-contain select-none pointer-events-none"
                                draggable={false}
                        ...
                        <div className="flex gap-6">
                            {socialLinks.map((social, index) => (
                                <motion.a
                                    ...
                                    href={social.href}
                                    target="_blank"
                                    className="w-8 h-8 md:w-16 md:h-16 rounded-full glass flex items-center justify-center hover:scale-110 transition-all cursor-pointer relative group"
                                    style={{ 
