...
const testimonials = [
    ...
    { id: 6, name: "Poulami Saha", img: poulami1, text: "Warm and supportive guidance. Felt very comfortable discussing my life problems." },
    { id: 7, name: "Poulami Chakraborty", img: poulami2, text: "Exceptional service! The predictions about my business growth were spot on." },
