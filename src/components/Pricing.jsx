        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {pricingData.map((item, idx) => (
            <motion.div
              ...
              className={`relative group rounded-[2.5rem] p-4 border shadow-2xl overflow-hidden transition-all duration-500 ${
                isDarkMode 
              ...
              <div className="px-4 pb-4">
                 ...
                 <div className="flex items-center justify-between mt-auto bg-black/5 dark:bg-white/5 p-4 rounded-2xl">
                    ...
                    <motion.button
                       ...
                       className={`px-6 py-3 rounded-xl font-black text-xs tracking-widest uppercase shadow-lg transition-all ${
                         isDarkMode 
