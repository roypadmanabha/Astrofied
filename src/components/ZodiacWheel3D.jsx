...
function ZodiacScene() {
    ...
    return (
        <>
            ...
            <pointLight position={[10, 10, 10]} intensity={1.5} color={isDarkMode ? '#ffd700' : '#A30000'} />
            ...
            <Float speed={1.5} rotationIntensity={0.5} floatIntensity={0.5}>
                <mesh ref={ringRef}>
                    ...
                    <meshStandardMaterial
                        color={isDarkMode ? '#bcd437ff' : '#A30000'}
                        emissive={isDarkMode ? '#c2d437ff' : '#A30000'}
                ...
                <mesh rotation={[Math.PI / 2, 0, 0]}>
                    ...
                    <meshBasicMaterial color={isDarkMode ? '#ffd700' : '#A30000'} transparent opacity={0.3} side={2} />
                </mesh>
            </Float>
        </>
    );
