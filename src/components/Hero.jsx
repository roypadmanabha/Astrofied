                    ...
                    <div className="w-full lg:w-1/2 text-center lg:text-left order-1 z-20">
                        ...
                        >
                            <button
                                ...
                                className={`flex-1 sm:flex-none px-3 py-3 sm:px-10 sm:py-4 rounded-[5px] sm:rounded-[15px] font-bold text-[11px] sm:text-lg transition-all shadow-xl hover:scale-105 active:scale-95 border-none cursor-pointer ${isDarkMode
                            ...
                            >
                             ...
                             <button
                                ...
                                className={`flex-1 sm:flex-none px-3 py-3 sm:px-10 sm:py-4 rounded-[5px] sm:rounded-[15px] font-bold text-[11px] sm:text-lg transition-all border glass hover:scale-105 active:scale-95 cursor-pointer ${isDarkMode
