      ...
      <div className="container mx-auto max-w-[1200px] flex justify-center">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-8 text-center drop-shadow-sm font-['Nunito']">
            ...
            <div className="w-[90%] sm:w-[80%] lg:w-[85%] rounded-[15px] overflow-hidden shadow-2xl bg-transparent">
              <img 
                src={journalsCollage} 
          ...
          <div className={`block lg:hidden w-full max-w-md h-px my-6 ${isDarkMode ? 'bg-white/20' : 'bg-black/20'}`}></div>

          {/* Right Side - Text and Buttons */}
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center h-full pt-4 lg:pt-0">
            <p className={`text-lg md:text-xl lg:text-2xl font-bold mb-12 text-center leading-relaxed font-['Nunito'] ${isDarkMode ? 'text-white' : 'text-black'}`}>
