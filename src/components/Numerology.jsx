            ...
            <div className="container mx-auto px-4 md:px-6 max-w-6xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {cards.map((card, idx) => (
                        <div 
                            key={idx} 
                            className={`rounded-2xl p-6 flex flex-col justify-between shadow-xl min-h-[350px] md:min-h-[400px] relative overflow-hidden ${isDarkMode ? 'bg-transparent border border-[#D4AF37]' : 'bg-gradient-to-b from-[#D00000] to-black'}`}
                        >
                            {/* Card Header */}
